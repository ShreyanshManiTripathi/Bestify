...
import { BOARD_SIZE,COLORS,GAME_MODES,CONTROLS } from "./constants";
import { BestScoreManager } from './storage.service.service';
...
export class SnakeComponent implements OnInit {
  ...
  public games:any=[] ;
  public all_modes = GAME_MODES as any ;
  public getKeys = Object.keys;
  public board =[] as any;
  public obstacles = [] as any;
  public score = 0;
  ...
  updatePositions(): void {
    ...
    let oldTail = this.snake.parts.pop() as any;
  ...
  gameOver(): void {
    ...
    this.bestScoreService.getGameTransaction(this.score,this.status,this.userId,this.games[0].gameId).subscribe(response=>{
  ...
  ngOnInit(): void {
    ...
    this.bestScoreService.getGameDetails()
    .subscribe(data => {this.games = data
            console.log(this.games[0].gameId);
    } )
